...
Direct Input sequence player for Where Winds Meet.
...
* 🚫 &nbsp;No need for administrative permissions or bloatware running.
...
### Synthax
`time_before_trigger` , `key_to_be_triggered`
```
time,key
```
Example (21 Keys)
...
Share your songs with everyone in the section below:
